package com.besirkaraoglu.circleimageview
...
class CircleImageView @JvmOverloads constructor(
    ...
    private var circleImageView: CircleImageViewImpl
    ...
    init {
        ...
        context.withStyledAttributes(attrs, R.styleable.CircleImageView) {
            borderSize = getDimensionPixelSize(R.styleable.CircleImageView_border_size, 0)
            borderColor = getColor(R.styleable.CircleImageView_border_color, borderColor)
            imageDrawable = getDrawable(R.styleable.CircleImageView_src)
        }
    ...
    private fun getCircleImageView(): CircleImageViewImpl {
        return CircleImageViewImpl(context).apply {
...
private class CircleImageViewImpl @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
    ...
    init {
        ...
        context.withStyledAttributes(attrs, R.styleable.CircleImageView) {
            customDrawable = getDrawable(R.styleable.CircleImageView_src)
        }
